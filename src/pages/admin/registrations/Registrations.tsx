...
export default function RegistrationsPage({
  ...
  const { data: registrationStatus } = useSettingQuery<"open" | "closed">(
    "registration_status"
  );
  ...
  }) as UseInfiniteQueryResult<ListResult<RegistrationsResponse>, unknown>;
              ...
              <div className="space-y-0.5">
                ...
                <p className={cn("text-sm text-muted-foreground")}>
                  {registrationStatus?.value === "open" &&
                    "You will be receiving any incoming registrations."}
                  {registrationStatus?.value === "closed" &&
                    "You will not be receiving any incoming registrations."}
                </p>
              </div>
              <Switch
